(function ($) {
  ...
  /*---------- 01. On Load Function ----------*/
   ...
   if ($("#preloader").length) {
    ...
    /*---------- Hero Main Slider Initialization ----------*/
    if ($('#heroMainSlider').length) {
        var heroSlider = $('#heroMainSlider');
        var heroSettings = heroSlider.data('slider-options') || {};
        
        var heroPrevBtn = heroSlider.find('.hero-slider-prev');
        var heroNextBtn = heroSlider.find('.hero-slider-next');
        var heroPaginationEl = heroSlider.find('.swiper-pagination').get(0);
        ...
        var heroSliderOptions = {
            ...
            navigation: {
                prevEl: heroPrevBtn.get(0),
                nextEl: heroNextBtn.get(0),
            },
            pagination: {
                el: heroPaginationEl,
                type: 'bullets',
        ...
        var mergedOptions = $.extend({}, heroSliderOptions, heroSettings);
        var heroSwiperInstance = new Swiper(heroSlider.get(0), mergedOptions);
    }
    ...
    function wowAnimation() {
        ...
        wow.init();
          ...
          if ($("#licenseSelect").length > 0) {

             const selectBox = document.getElementById("licenseSelect");
            const optionsBox = document.querySelector(".license-options");
            ...
            option.addEventListener("click", function (e) {
                ...
                selectedText.textContent = this.dataset.name;
